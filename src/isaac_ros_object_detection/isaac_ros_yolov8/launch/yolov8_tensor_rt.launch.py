...
def generate_launch_description():
    ...
    launch_args = [
        ...
        DeclareLaunchArgument(
            'network_image_width',
            default_value='640',
            description='Network input image width'),
        DeclareLaunchArgument(
            'network_image_height',
            default_value='640',
            description='Network input image height'),
        DeclareLaunchArgument(
            'image_mean',
            default_value='[0.0, 0.0, 0.0]',
            description='Image mean for normalization'),
        DeclareLaunchArgument(
            'image_stddev',
            default_value='[1.0, 1.0, 1.0]',
            description='Image standard deviation for normalization'),
    ]
    ...
    yolov8_encoder_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'image_input_topic': '/camera/color/image_rect_raw',  # RealSense color topic
            'camera_info_input_topic': '/camera/color/camera_info',  # RealSense camera info
